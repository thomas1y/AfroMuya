// File: src/components/jobs/JobDetailsHeader.js
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6">
              ...
              <Link 
                href={job.applyLink || `/jobs/apply/${job.id}`}
                className="w-full bg-[#309689] text-white px-6 py-4 rounded-xl hover:bg-[#2a877a] transition-colors font-semibold text-lg flex items-center justify-center"
              >
                Apply Now
              </Link>
